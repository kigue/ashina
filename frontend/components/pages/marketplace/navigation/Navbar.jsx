      ...
      <Navbar expand="lg" style={{ backgroundColor: 'darkgreen' }}>
        <Container fluid>
          <Navbar.Brand href="/marketplace">
            ...
            <span className="ml-2 navbar-brand-custom">Ashina Marketplace</span>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <div className="search-bar-custom">
              <input type="text" placeholder="Search for Farms, Produce, Inputs and More..." className="search-input-custom"/>
            </div>
