  ...
  render() {
    return (
      <Navbar expand="lg" style={{ height: '75px', backgroundColor: 'darkgreen' }}>
        <Container fluid>
          <Navbar.Brand href="/farm">
            <Image src={logo} width="30" height="30" className="d-inline-block align-top" />
            <span className="ml-2 navbar-brand-custom">Ashina Farms</span>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <div className="search-bar-custom">
              <input type="text" placeholder="Search for Farms, Produce, Marketplace Items..." className="search-input-custom"/>
            </div>
